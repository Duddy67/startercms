...
@section ('main')
    ...
    <input type="hidden" id="destroyItems" value="{{ route('admin.users.users.index', $query) }}">
    <input type="hidden" id="checkinItems" value="{{ route('admin.users.users.massCheckIn', $query) }}">
